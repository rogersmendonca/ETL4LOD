...
public class SparqlStepMeta extends BaseStepMeta implements StepMetaInterface
{
            ...
            throws KettleException
    {
        ...
        prefixes = (List<List<String>>) new XStream().fromXML(repository
                .getStepAttributeString(stepIdInRepository,
                        Field.PREFIXES.name()));
        varPrefix = repository.getStepAttributeString(stepIdInRepository,
                Field.VAR_PREFIX.name());
    }
            ...
            ObjectId idOfStep) throws KettleException
    {
        ...
        repository.saveStepAttribute(idOfTransformation, idOfStep,
                Field.VAR_PREFIX.name(), varPrefix);
    }
            ...
            throws KettleStepException
    {
        ...
        List<ValueMetaInterface> outVars = SparqlStepUtils.generateOutputVars(
                varPrefix, this.getFullQueryString());
    ...
    {
        return SparqlStepUtils.generateOutputVars(varPrefix,
                getFullQueryString());
    }
