...
public class DataPropertyMappingStep extends BaseStep implements StepInterface
{
    ...
    public DataPropertyMappingStep(StepMeta stepMeta,
            ...
            throws KettleException
    {
        ...
        // Add rdf:type
        String subject = getInputRowMeta().getString(row,
                meta.getSubjectUriFieldName(), "");
        ...
        while (it.hasNext())
        {
            ...
            putOutRow(row, meta, data, subject,
        ...
        for (int i = 0; i < table.size(); i++)
        {
            ...
            String predicate = table.getValue(i,
                    DataPropertyMappingStepMeta.Field.MAP_TABLE_PREDICATE_URI
                            .name());

            String objectField = table
                    .getValue(
                            i,
            ...
            {
                langtag = getInputRowMeta().getString(row,
                        getInputRowMeta().indexOfValue(langtagField));
            }
            ...
            try
            {
                ...
                {
                    object = getInputRowMeta().getInteger(row, index)
                            .toString();
                }
                else
                {
            ...
            if (subject != null && predicate != null && object != null
                    && !"".equals(subject) && !"".equals(predicate)
                    && !"".equals(object))
            {
    ...
    private void putOutRow(Object[] inputRow, DataPropertyMappingStepMeta meta,
            DataPropertyMappingStepData data, String subject, String predicate,
            String object) throws KettleStepException
    {
    ...
    private void putOutRow(Object[] inputRow, DataPropertyMappingStepMeta meta,
            DataPropertyMappingStepData data, String subject, String predicate,
            String object, String datatype, String langtag)
            throws KettleStepException
    {
        ...
        if (meta.isThereAdditionalSubjectOutputField())
        { // addS
        ...
        if (datatype == null || datatype.isEmpty()
                || "http://www.w3.org/2001/XMLSchema#string".equals(datatype))
        {
            outputRow = RowDataUtil.addValueData(outputRow, outputRowPos++,
                    langtag);
        }
