...
/**
 * Interface de usuario do step SemanticLevelMarker.
 * 
 * @author Kelli de Faria Cordeiro
 * 
 */
public class SemanticLevelMarkerStepDialog extends BaseStepDialog implements
        StepDialogInterface
{
    // for i18n purposes, needed by Translator2!! $NON-NLS-1$
    private static Class<?> PKG = SemanticLevelMarkerStepMeta.class;

    private SemanticLevelMarkerStepMeta input;
...
//    private ComboVar wInputLangTag;
    ...
    public SemanticLevelMarkerStepDialog(Shell parent, Object stepMeta,
            TransMeta transMeta, String stepname)
    {
        super(parent, (BaseStepMeta) stepMeta, transMeta, stepname);

        input = (SemanticLevelMarkerStepMeta) baseStepMeta;
        swthlp = new SwtHelper(transMeta, this.props);

        // Additional initialization here
        dialogTitle = BaseMessages.getString(PKG, "SemanticLevelMarkerStep.Title");
    }
            ...
            ModifyListener defModListener)
    {
        wInputGroup = swthlp.appendGroup(shell, lastControl,
                BaseMessages.getString(PKG, "SemanticLevelMarkerStep.Group.Input.Label"));
        wInputSubject = appendComboVar(wInputGroup, defModListener,
                wInputGroup, BaseMessages.getString(PKG, "SemanticLevelMarkerStep.SubjectField.Label"));
        wInputPredicate = appendComboVar(wInputSubject, defModListener,
                wInputGroup, BaseMessages.getString(PKG, "SemanticLevelMarkerStep.PredicateField.Label"));
        wInputObject = appendComboVar(wInputPredicate, defModListener,
                wInputGroup, BaseMessages.getString(PKG, "SemanticLevelMarkerStep.ObjectField.Label"));
        wOutputGroup = swthlp.appendGroup(shell, wInputGroup, BaseMessages.getString(PKG, "SemanticLevelMarkerStep.Group.Output.Label"));
        wInnerKeepInput = swthlp.appendCheckboxRow(wOutputGroup, wOutputGroup,
                BaseMessages.getString(PKG, "SemanticLevelMarkerStep.PassCheckField.Label"),
        ...
        wOutputNTriple = swthlp.appendTextVarRow(wOutputGroup, wInnerKeepInput,
                BaseMessages.getString(PKG, "SemanticLevelMarkerStep.NTripleField.Label"), defModListener);
    ...
    public String open()
    {
        ...
        wlStepname.setText(BaseMessages.getString(PKG, "SemanticLevelMarkerStep.StepNameField.Label"));
        ...
        wOK.setText(BaseMessages.getString(PKG, "SemanticLevelMarkerStep.Btn.OK")); //$NON-NLS-1$
        wCancel = new Button(shell, SWT.PUSH);
        wCancel.setText(BaseMessages.getString(PKG, "SemanticLevelMarkerStep.Btn.Cancel")); //$NON-NLS-1$
