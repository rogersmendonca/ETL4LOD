    ...
    private void validateStatement()
    {
        ...
        else if (object.isLiteral())
        {
            ...
            if (datatype != null)
                ...
                object = model.createLiteral(
                        literal.getString().replaceAll("\"", "")
                                .replaceAll("''", ""), language);
            else
                object = model.createLiteral(literal.getLexicalForm()
                        .replaceAll("\"", "").replaceAll("''", ""));
        }

        Statement newStmt = model.createStatement(
                model.createResource(subject), model.createProperty(predicate),
                object);
