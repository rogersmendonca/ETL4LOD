        ...
        StepDialogInterface
{
    ...
    public String open()
    {
        ...
        wlStepname.setText(BaseMessages.getString(PKG,
                "AnnotatorStep.StepNameField.Label"));
        ...
        wlSubject.setText(BaseMessages.getString(PKG,
                "AnnotatorStep.SubjectField.Label"));
        ...
        wcSubject = new ComboVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
                | SWT.BORDER);
        ...
        wcSubject.addFocusListener(new FocusListener()
        {
            ...
            public void focusGained(org.eclipse.swt.events.FocusEvent e)
            {
                ...
                BaseStepDialog.getFieldsFromPrevious(wcSubject, transMeta,
                        stepMeta);
        ...
        wlPredicate.setText(BaseMessages.getString(PKG,
                "AnnotatorStep.PredicateField.Label"));
        ...
        wcPredicate = new ComboVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
                | SWT.BORDER);
        ...
        wcPredicate.addFocusListener(new FocusListener()
        {
            ...
            public void focusGained(org.eclipse.swt.events.FocusEvent e)
            {
                Cursor busy = new Cursor(shell.getDisplay(), SWT.CURSOR_WAIT);
                shell.setCursor(busy);
                BaseStepDialog.getFieldsFromPrevious(wcPredicate, transMeta,
                        stepMeta);
                shell.setCursor(null);
                busy.dispose();
            }
        ...
        wlObject.setText(BaseMessages.getString(PKG,
                "AnnotatorStep.ObjectField.Label"));
        ...
        wcObject = new ComboVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
                | SWT.BORDER);
        ...
        wcObject.addFocusListener(new FocusListener()
        {
            ...
            public void focusGained(org.eclipse.swt.events.FocusEvent e)
            {
                Cursor busy = new Cursor(shell.getDisplay(), SWT.CURSOR_WAIT);
                shell.setCursor(busy);
                BaseStepDialog.getFieldsFromPrevious(wcObject, transMeta,
                        stepMeta);
                shell.setCursor(null);
                busy.dispose();
            }
        ...
        wlNTriple.setText(BaseMessages.getString(PKG,
                "AnnotatorStep.NTripleField.Label")); //$NON-NLS-1$
        ...
        wtNTriple = new TextVar(transMeta, shell, SWT.SINGLE | SWT.LEFT
                | SWT.BORDER);
        ...
        wbBrowse.setText(BaseMessages
                .getString(PKG, "AnnotatorStep.Btn.Browse"));
        ...
        wBrowse.addModifyListener(new ModifyListener()
        {
            ...
            {
                wBrowse.setToolTipText(transMeta.environmentSubstitute(wBrowse
                        .getText()));
            }
        });
