...
public class SparqlRunQueryStepMeta extends BaseStepMeta implements
        StepMetaInterface
{
    ...
    {
        return new SparqlRunQueryStep(stepMeta, stepDataInterface, copyNr,
                transMeta, trans);
    }
            ...
            Map<String, Counter> sequenceCounters) throws KettleXMLException
    {
        ...
        queryTextContentFieldName = XMLHandler.getTagValue(stepDomNode,
                Field.QUERY_CONTENT.name());
    ...
    public String getXML() throws KettleException
    {
        ...
        xml.append(XMLHandler.addTagValue(Field.QUERY_CONTENT.name(),
            ...
            throws KettleException
    {
        ...
        queryTextContentFieldName = repository.getStepAttributeString(
                stepIdInRepository, Field.QUERY_CONTENT.name());
            ...
            ObjectId idOfStep) throws KettleException
    {
        ...
        repository.saveStepAttribute(idOfTransformation, idOfStep,
                Field.QUERY_CONTENT.name(), queryTextContentFieldName);
        repository.saveStepAttribute(idOfTransformation, idOfStep,
