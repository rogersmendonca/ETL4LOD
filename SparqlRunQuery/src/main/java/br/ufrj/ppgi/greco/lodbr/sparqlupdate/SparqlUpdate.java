...
public class SparqlUpdate
{
    ...
    public int runQuery(String queryText)
    {
        ...
        qparams.add(new BasicNameValuePair("query", queryText));
        qparams.add(new BasicNameValuePair("format",
                "application/sparql-results+xml"));

        try
        {
            URI uri = URIUtils.createURI(this.protocol, this.host, this.port,
                    this.path, URLEncodedUtils.format(qparams, "UTF-8"), null);
        ...
        {
            printLog("SparqlRunQuery", "runQuery");
    ...
    public HttpResponse insertNTriples(String graph, String triples)
            throws Exception
    {
    ...
    public Response insertTriples(String graph, String RDFXML) throws Exception
    {
        ...
        try
        {
            ...
            URI uri = URIUtils.createURI(this.protocol, this.host, this.port,
                    this.path, null, null); // URLEncodedUtils.format(qParams,
                                            // "UTF-8")
            ...
            operationResult = new Response(resposta.getStatusLine()
                    .getStatusCode(), resposta.getStatusLine()
                    .getReasonPhrase());
    ...
    public Response insertTriples(String graph, String rdfxml, int blockSize)
            throws Exception
    {
        Response operationResult = null;
    ...
    public int deleteTriple(String graph, String RDFXML)
    {
        ...
        List<NameValuePair> qparams = new ArrayList<NameValuePair>();
        qparams.add(new BasicNameValuePair("query", "DELETE FROM <" + graph
                + ">{" + n3 + "}"));
        qparams.add(new BasicNameValuePair("format",
                "application/sparql-results+xml"));
    ...
    public static String convert(Format inputFormat, String inputData,
            String defaultURI, Format outputFormat) throws Exception
    {
        String n3 = "";
        try
        {
            ...
            DocumentSource source = new StringDocumentSource(inputData,
                    defaultURI, inputMime, "UTF-8");
        ...
        catch (Exception e)
        {
            ...
            String msg = String.format("%s -> %s. INPUT=[[%s]]",
                    inputFormat.name(), outputFormat.name(), inputData);
    ...
    private String triplify(String defaultURI, String rdfxml)
    {
        ...
        try
        {
            ...
            DocumentSource source = new StringDocumentSource(rdfxml,
                    defaultURI, "application/rdf+xml", "UTF-8");
