...
public class SparqlRunQueryStep extends BaseStep implements StepInterface
{
	  ...
	  private int MAX_TRIPLES_COUNT = 1000;
	            ...
	            throws KettleException
	    {
	        ...
	        if (row == null)
	        {
	            try
	            {
	            	...
	            	//TODO Alterar Triple para Query nos m�todos e vari�veis
	    ...
	    private void insertTripleList(SparqlRunQueryStepMeta meta,
	    		SparqlRunQueryStepData data, int begin, int end)
	            throws KettleStepException
	    {
	        ...
	        try
	        {
	            ...
	            String queryContent = serializeQueries(meta, data, begin, end);
	            
	            response = data.sparqlUpdate.runQuery(data.graphUri, queryContent);
	    ...
	    private String serializeQueries(SparqlRunQueryStepMeta meta,
	            SparqlRunQueryStepData data, int begin, int end)
	            throws TripleSerializationException, KettleValueException
	    {
	        ...
	        for (int i = begin; i < end; i++)
	        {
	            ...
	            String query = rowMeta.getString(row,
	    ...
	    private void putResultRow(SparqlRunQueryStepData data,
	    ...
	    private void putResultRow(SparqlRunQueryStepData data, long code,
