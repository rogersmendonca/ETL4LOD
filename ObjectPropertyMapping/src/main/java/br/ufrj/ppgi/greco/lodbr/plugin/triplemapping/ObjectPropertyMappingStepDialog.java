...
public class ObjectPropertyMappingStepDialog extends BaseStepDialog implements
        StepDialogInterface
{
    ...
    public ObjectPropertyMappingStepDialog(Shell parent, Object stepMeta,
            ...
            ModifyListener defModListener)
    {
        ...
        wObjectOutputFieldName = swthlp.appendTextVarRow(cpt,
                ...
                defModListener);
        Label wLabel = swthlp
                .appendLabel(cpt, wObjectOutputFieldName,
        ...
        wSubjectOutputFieldName
                .setToolTipText("Diferentemente do Mapeamento DataProperty, este campo é obrigatório.");
