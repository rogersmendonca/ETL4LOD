 ...
 * 
 */
public class GraphSemanticLevelMarkerStepMeta extends BaseStepMeta implements StepMetaInterface {
	public enum Field {
		INPUT_GRAPH, OUTPUT_SUBJECT, OUTPUT_PREDICATE, OUTPUT_OBJECT, INPUT_BROWSE_FILE_NAME, INPUT_RULES_FILE_NAME
	}
	...
	public StepInterface getStep(StepMeta stepMeta, StepDataInterface stepDataInterface, int copyNr,
		...
		return new GraphSemanticLevelMarkerStep(stepMeta, stepDataInterface, copyNr, transMeta, trans);
	}
	...
	public void saveRep(Repository repository, ObjectId idOfTransformation, ObjectId idOfStep) throws KettleException {
		...
		repository.saveStepAttribute(idOfTransformation, idOfStep, Field.INPUT_RULES_FILE_NAME.name(), rulesFilename);
	}
