...
public class Main {
	...
	public static void main(String[] args) throws Exception {
		 ...
		 * 
		 * //File file = new
		 * File("C:\\Users\\Expedito\\Downloads\\download.rdf"); File file = new
		 * File("D:\\User\\LodBr\\Kettle\\rdf\\lattes.rdf"); //File file = new
		 * File("D:\\User\\LodBr\\Kettle\\rdf\\teste.rdf"); byte[] buffer = new
		 * byte[(int) file.length()]; BufferedInputStream f = new
		 * BufferedInputStream(new FileInputStream(file)); f.read(buffer);
